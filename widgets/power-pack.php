...
class UTOFC_Effective_widgets extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Table of Content', 'useful-table-of-content'),
			]
		);
		...
		$this->add_control(
			'layout',
			[
				'label'    => __('Layout', 'useful-table-of-content'),
				'type'     => Controls_Manager::SELECT,
				'default'  => 'offcanvas',
				'options'  => [
					'offcanvas' => esc_html__('Offcanvas', 'useful-table-of-content'),
					'fixed'     => esc_html__('Fixed', 'useful-table-of-content'),
					'dropdown'  => esc_html__('Dropdown', 'useful-table-of-content'),
					'regular'   => esc_html__('Regular', 'useful-table-of-content'),
				],
			]
		);
		...
		$this->add_control(
			'index_align',
			[
				'label'    => __('Offcanvas Position', 'useful-table-of-content'),
				'type'     => Controls_Manager::SELECT,
				'default'  => 'left',
				'options'  => [
					'left'     => esc_html__('Left', 'useful-table-of-content'),
					'right'    => esc_html__('Right', 'useful-table-of-content'),
				],
				'condition' => [
					'layout' => 'offcanvas',
				]
		...
		$this->add_control(
			'fixed_position',
			[
				'label'    => __('Content Position', 'useful-table-of-content'),
				'type'     => Controls_Manager::SELECT,
				'default'  => 'top-left',
				'options'  => [
					'top-left'     => esc_html__('Top-Left', 'useful-table-of-content'),
					'top-right'    => esc_html__('Top-Right', 'useful-table-of-content'),
					'bottom-left'  => esc_html__('Bottom-Left', 'useful-table-of-content'),
					'bottom-right' => esc_html__('Bottom-Right', 'useful-table-of-content'),
				],
				'condition' => [
					'layout' => 'fixed',
				]
		...
		$this->add_control(
			'selectors',
			[
				'label'       => __('Index Tags', 'useful-table-of-content'),
				'description' => __('Want to ignore any specific heading? Go to that heading advanced tab and enter <b>ignore-this-tag</b> class in <a href="http://prntscr.com/lvw4iy" target="_blank">CSS Classes</a> input field.', 'useful-table-of-content'),
				'type'        => Controls_Manager::SELECT2,
				'multiple'    => true,
				'default'     => ['h2', 'h3', 'h4'],
				'options'     => sksk01_element_pack_heading_size(),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __('Offset', 'useful-table-of-content'),
				'type' => Controls_Manager::POPOVER_TOGGLE,
				'label_off' => __('None', 'useful-table-of-content'),
				'label_on' => __('Custom', 'useful-table-of-content'),
				'return_value' => 'yes',
				'separator' => 'before',
				'condition' => [
					'layout' => 'fixed'
		...
		$this->add_responsive_control(
			...
			[
				'label'     => __('Horizontal Offset', 'useful-table-of-content'),
		...
		$this->add_responsive_control(
			...
			[
				'label'   => __('Vertical Offset', 'useful-table-of-content'),
				'type'    => Controls_Manager::SLIDER,
				'default' => [
					'size' => 0,
				],
		...
		$this->add_control(
			'offset',
			[
				'label'     => __('Scroll to Indexed Top Offset', 'useful-table-of-content'),
				'type'      => Controls_Manager::SLIDER,
				'separator' => 'before',
				'description'     => __('Scroll will stop after this offset from top', 'useful-table-of-content'),
				'default'   => [
					'size' => 10,
				],
				'range' => [
		...
		$this->add_responsive_control(
			'content_width',
			[
				'label'      => esc_html__('Content Width', 'useful-table-of-content'),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px', 'vw'],
				'range'      => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__('Button', 'useful-table-of-content'),
				'condition' => [
		...
		$this->add_control(
			'button_text',
			[
				'label'       => __('Button Text', 'useful-table-of-content'),
		...
		$this->add_control(
			'table_button_icon',
			[
				'label'       => __('Button Icon', 'useful-table-of-content'),
		...
		$this->add_control(
			'button_icon_align',
			[
				'label'   => __('Icon Position', 'useful-table-of-content'),
				'type'    => Controls_Manager::SELECT,
				'default' => 'right',
				'options' => [
					'left'   => __('Left', 'useful-table-of-content'),
					'right'  => __('Right', 'useful-table-of-content'),
				],
				'condition' => [
		...
		$this->add_control(
			'button_icon_indent',
			[
				'label' => __('Icon Spacing', 'useful-table-of-content'),
				'type'  => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 100,
		...
		$this->add_control(
			'button_position',
			[
				'label'   => esc_html__('Button Position', 'useful-table-of-content'),
				'type'    => Controls_Manager::SELECT,
				'options' => sksk01_element_pack_position(),
				'default' => 'top-left',
				'condition' => [
        ...
        $this->add_responsive_control(
            'button_rotate',
            [
                'label' => esc_html__('Rotate', 'useful-table-of-content'),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 0,
                ],
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__('Dropdown Options', 'useful-table-of-content'),
				'condition' => [
					'layout' => 'dropdown',
				]
			]
		...
		$this->add_control(
			'drop_position',
			[
				'label'   => esc_html__('Position', 'useful-table-of-content'),
				'type'    => Controls_Manager::SELECT,
				'default' => 'bottom-left',
				'options' => sksk01_element_pack_drop_position(),
			]
		);
		...
		$this->add_control(
			'drop_mode',
			[
				'label'   => esc_html__('Mode', 'useful-table-of-content'),
				'type'    => Controls_Manager::SELECT,
				'default' => 'hover',
				'options' => [
					'click'    => esc_html__('Click', 'useful-table-of-content'),
					'hover'  => esc_html__('Hover', 'useful-table-of-content'),
				],
			]
		);
		...
		$this->add_control(
			'drop_flip',
			[
				'label' => esc_html__('Flip Dropbar', 'useful-table-of-content'),
		...
		$this->add_control(
			'drop_offset',
			[
				'label'   => esc_html__('Dropbar Offset', 'useful-table-of-content'),
				'type'    => Controls_Manager::SLIDER,
				'default' => [
					'size' => 0,
				],
		...
		$this->add_control(
			'drop_animation',
			[
				'label'     => esc_html__('Animation', 'useful-table-of-content'),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'fade',
				'options'   => sksk01_element_pack_transition_options(),
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'drop_duration',
			[
				'label'   => esc_html__('Animation Duration', 'useful-table-of-content'),
				'type'    => Controls_Manager::SLIDER,
				'default' => [
					'size' => 200,
				],
		...
		$this->add_control(
			'drop_show_delay',
			[
				'label'   => esc_html__('Show Delay', 'useful-table-of-content'),
				'type'    => Controls_Manager::SLIDER,
				'default' => [
					'size' => 0,
				],
		...
		$this->add_control(
			'drop_hide_delay',
			[
				'label'   => esc_html__('Hide Delay', 'useful-table-of-content'),
				'type'    => Controls_Manager::SLIDER,
				'default' => [
					'size' => 800,
				],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Additional', 'useful-table-of-content'),
			]
		);
		...
		$this->add_control(
			'context',
			[
				'label'       => __('Index Area (any class/id selector)', 'useful-table-of-content'),
				'description'       => __('Any class or ID selector accept here for your table of content.', 'useful-table-of-content'),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'default'     => '.elementor',
		...
		$this->add_control(
			'auto_collapse',
			[
				'label'     => esc_html__('Auto Collapse Sub Index', 'useful-table-of-content'),
				'separator' => 'before',
				'type'      => Controls_Manager::SWITCHER,
			]
		);
		...
		$this->add_control(
			'history',
			[
				'label' => esc_html__('Click History', 'useful-table-of-content'),
				'type'  => Controls_Manager::SWITCHER,
				'description'       => __('Click History is the list of web pages a user has visited recently of Table Of Content.', 'useful-table-of-content'),
			]
		);
		...
		$this->add_control(
			'toc_index_header',
			[
				'label'       => __('Index Header Text', 'useful-table-of-content'),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
		...
		$this->add_control(
			'toc_sticky_mode',
			[
				'label'   => esc_html__('Index Sticky', 'useful-table-of-content'),
				'type'    => Controls_Manager::SWITCHER,
				'condition' => [
					'layout' => 'regular',
				],
		...
		$this->add_control(
			'toc_sticky_offset',
			[
				'label'   => esc_html__('Sticky Offset', 'useful-table-of-content'),
				'type'    => Controls_Manager::SLIDER,
				'default' => [
					'size' => 0,
				],
		...
		$this->add_control(
			...
			[
				'label'        => esc_html__('Sticky on Scroll Up', 'useful-table-of-content'),
				'type'         => Controls_Manager::SWITCHER,
				'description'  => esc_html__('Set sticky options when you scroll up your mouse.', 'useful-table-of-content'),
				'condition' => [
					'toc_sticky_mode' => 'yes',
					'layout' => 'regular',
				],
		...
		$this->add_control(
			'toc_sticky_edge',
			[
				'label'       => __('Scrolling Area', 'useful-table-of-content'),
				'description' => __('Set the css class/ID scrolling area section parent tag class/ID', 'useful-table-of-content'),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
		...
		$this->add_control(
			'index_background',
			[
				'label'     => __('Background Color', 'useful-table-of-content'),
		...
		$this->add_control(
			'index_radius',
			[
				'label'      => __('Radius', 'useful-table-of-content'),
		...
		$this->add_responsive_control(
			'index_padding',
			[
				'label'      => __('Padding', 'useful-table-of-content'),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
		...
		$this->add_responsive_control(
			'index_min_height',
			[
				'label' => __('Min Height', 'useful-table-of-content'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px', 'vh'],
				'range' => [
					'px' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => __('Box Shadow', 'useful-table-of-content'),
				'selector' => '#bdt-toc-{{ID}} > div',
			]
		);
		...
		$this->start_controls_section(
			'header_style',
			[
				'label' => __('Header', 'useful-table-of-content'),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'toc_index_header!' => '',
				],
		...
		$this->add_control(
			'header_text_color',
			[
				'label'     => __('Text Color', 'useful-table-of-content'),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'header_radius',
			[
				'label'      => __('Border Radius', 'useful-table-of-content'),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', '%'],
				'selectors'  => [
		...
		$this->add_responsive_control(
			'header_margin',
			[
				'label'      => __('Margin', 'useful-table-of-content'),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
		...
		$this->start_controls_section(
			'section_style_list',
			[
				'label' => esc_html__('List', 'useful-table-of-content'),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'index_spacing',
			[
				'label'   => esc_html__('Title Spacing', 'useful-table-of-content'),
				'type'    => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->start_controls_tab(
			'normal',
			[
				'label' => __('Normal', 'useful-table-of-content'),
			]
		);
		...
		$this->add_control(
			'title_color',
			[
				'label'     => __('Color', 'useful-table-of-content'),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => __('Underline', 'useful-table-of-content'),
				'type'      => Controls_Manager::SWITCHER,
				'selectors' => [
		...
		$this->start_controls_tab(
			'hover',
			[
				'label' => __('Hover', 'useful-table-of-content'),
			]
		);
		...
		$this->start_controls_tab(
			'active',
			[
				'label' => __('Active', 'useful-table-of-content'),
			]
		);
		...
		$this->add_control(
			'button_background',
			[
				'label'     => __('Background', 'useful-table-of-content'),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Border Color', 'useful-table-of-content'),
				'type'      => Controls_Manager::COLOR,
				'condition' => [
